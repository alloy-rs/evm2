...
- [ ] README.md.diff
- [ ] crates__revmc-backend__Cargo.toml.diff
- [ ] crates__revmc-backend__README.md.diff
- [ ] crates__revmc-backend__src__traits.rs.diff
- [ ] crates__revmc-build__Cargo.toml.diff
- [ ] crates__revmc-build__README.md.diff
- [ ] crates__revmc-build__src__lib.rs.diff
- [ ] crates__revmc-builtins__Cargo.toml.diff
- [ ] crates__revmc-builtins__README.md.diff
- [ ] crates__revmc-builtins__src__gas.rs.diff
- [ ] crates__revmc-builtins__src__ir.rs.diff
- [ ] crates__revmc-builtins__src__lib.rs.diff
- [ ] crates__revmc-builtins__src__macros.rs.diff
- [ ] crates__revmc-builtins__src__utils.rs.diff
- [ ] crates__revmc-codegen__Cargo.toml.diff
- [ ] crates__revmc-codegen__README.md.diff
- [ ] crates__revmc-codegen__build.rs.diff
- [ ] crates__revmc-codegen__src__bytecode__asm.rs.diff
...
- [ ] crates__revmc-codegen__src__bytecode__opcode.rs.diff
- [ ] crates__revmc-codegen__src__bytecode__passes__block_analysis.rs.diff
- [ ] crates__revmc-codegen__src__bytecode__passes__const_fold.rs.diff
- [ ] crates__revmc-codegen__src__bytecode__passes__dead_store_elim.rs.diff
- [ ] crates__revmc-codegen__src__bytecode__passes__dedup.rs.diff
- [ ] crates__revmc-codegen__src__bytecode__passes__memory_sections.rs.diff
- [ ] crates__revmc-codegen__src__bytecode__passes__sections.rs.diff
- [ ] crates__revmc-codegen__src__compiler__mod.rs.diff
- [ ] crates__revmc-codegen__src__compiler__translate__mod.rs.diff
- [ ] crates__revmc-codegen__src__compiler__translate__peephole.rs.diff
- [ ] crates__revmc-codegen__src__compiler__translate__vstack.rs.diff
- [ ] crates__revmc-codegen__src__lib.rs.diff
- [ ] crates__revmc-codegen__src__linker.rs.diff
- [ ] crates__revmc-codegen__src__tests__fibonacci.rs.diff
- [ ] crates__revmc-codegen__src__tests__macros.rs.diff
...
- [ ] crates__revmc-context__README.md.diff
- [ ] crates__revmc-context__src__arch__aarch64.rs.diff
- [ ] crates__revmc-context__src__arch__mod.rs.diff
- [ ] crates__revmc-context__src__arch__x86_64.rs.diff
- [ ] crates__revmc-context__src__lib.rs.diff
- [ ] crates__revmc-llvm__Cargo.toml.diff
- [ ] crates__revmc-llvm__README.md.diff
- [ ] crates__revmc-llvm__build.rs.diff
- [ ] crates__revmc-llvm__cpp__lib.cpp.diff
- [ ] crates__revmc-llvm__src__cpp.rs.diff
- [ ] crates__revmc-llvm__src__lib.rs.diff
- [ ] crates__revmc-llvm__src__orc.rs.diff
- [ ] crates__revmc-llvm__src__utils.rs.diff
- [ ] crates__revmc-runtime__Cargo.toml.diff
- [ ] crates__revmc-runtime__README.md.diff
- [ ] crates__revmc-runtime__src__lib.rs.diff
- [ ] crates__revmc-runtime__src__revm_evm.rs.diff
- [ ] crates__revmc-runtime__src__runtime__api.rs.diff
- [ ] crates__revmc-runtime__src__runtime__backend.rs.diff
- [ ] crates__revmc-runtime__src__runtime__config.rs.diff
- [ ] crates__revmc-runtime__src__runtime__mod.rs.diff
- [ ] crates__revmc-runtime__src__runtime__out_of_process.rs.diff
- [ ] crates__revmc-runtime__src__runtime__stats.rs.diff
- [ ] crates__revmc-runtime__src__runtime__storage.rs.diff
- [ ] crates__revmc-runtime__src__runtime__tests.rs.diff
- [ ] crates__revmc-runtime__src__runtime__worker.rs.diff
- [ ] crates__revmc__Cargo.toml.diff
- [ ] crates__revmc__build.rs.diff
- [ ] crates__revmc__src__lib.rs.diff
- [ ] docs__out-of-process-jit.md.diff
- [ ] examples__compiler__Cargo.toml.diff
- [ ] examples__compiler__build.rs.diff
- [ ] examples__compiler__src__main.rs.diff
- [ ] scripts__bench.py.diff
- [ ] scripts__utils.py.diff
