...
pub fn with_jit_compiler<R>(
    ...
    compiler.set_single_error(false);
    f(&mut compiler)
}
    ...
    call_gas {
        ...
        call_known_bytecode(@raw {
            bytecode: &[
                ...
                op::PUSH1, 0,    // args offset
                op::PUSH1, 0,    // value
                op::PUSH1, 0x69, // address (OTHER_ADDR = 0x69..69, has code in fixture DB)
                op::PUSH1, 7,    // gas
                op::CALL,
            ],
            spec_id: SpecId::CANCUN,
