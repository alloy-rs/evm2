...
extern "C" LLVMAttributeRef evm2_jit_llvm_create_initializes_attr(LLVMContextRef C,
                                                               int64_t Lower,
                                                               int64_t Upper) {
  auto &Ctx = *unwrap(C);
...
evm2_jit_llvm_execution_session_remove_jit_dylib(LLVMOrcExecutionSessionRef ES,
...
extern "C" void
evm2_jit_llvm_jit_dylib_add_to_link_order(LLVMOrcJITDylibRef JD,
...
extern "C" void evm2_jit_llvm_lljit_builder_set_concurrent_compiler(
...
extern "C" LLVMErrorRef
evm2_jit_llvm_lljit_lookup_in(LLVMOrcLLJITRef J, LLVMOrcJITDylibRef JD,
...
extern "C" LLVMErrorRef
evm2_jit_llvm_lljit_enable_memory_usage(LLVMOrcLLJITRef J,
...
///
/// Returns an error if the object layer is not JITLink-based.
extern "C" LLVMErrorRef evm2_jit_llvm_lljit_enable_simple_perf(LLVMOrcLLJITRef J) {
  auto *Jit = reinterpret_cast<orc::LLJIT *>(J);
  auto *OLL = dyn_cast<orc::ObjectLinkingLayer>(&Jit->getObjLinkingLayer());
  if (!OLL)
...
/// not ELF.
extern "C" LLVMErrorRef
evm2_jit_llvm_lljit_enable_perf_support(LLVMOrcLLJITRef J) {
  auto *Jit = reinterpret_cast<orc::LLJIT *>(J);
  auto *OLL = dyn_cast<orc::ObjectLinkingLayer>(&Jit->getObjLinkingLayer());
  if (!OLL)
...
extern "C" LLVMErrorRef
evm2_jit_llvm_lljit_enable_debug_support(LLVMOrcLLJITRef J) {
  auto *Jit = reinterpret_cast<orc::LLJIT *>(J);
  auto &ES = Jit->getExecutionSession();
...
extern "C" void
evm2_jit_llvm_target_machine_set_opt_level(LLVMTargetMachineRef TM,
...
extern "C" void evm2_jit_llvm_set_dso_local(LLVMValueRef Val, bool Local) {
