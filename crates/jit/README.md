...
cargo nextest run -p evm2-jit -E 'test(statetest::)'

# A specific mode:
cargo nextest run -p evm2-jit -E 'test(statetest::jit)'

# A specific test subdirectory:
SUBDIR=stSelfBalance cargo nextest run -p evm2-jit -E 'test(statetest::jit)'
```
