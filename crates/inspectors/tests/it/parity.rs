...
use evm2_inspectors::tracing::{
    TracingInspector, TracingInspectorConfig, parity::populate_state_diff,
};
...
fn test_parity_constructor_selfdestruct() {
    ...
    */
    ...
    let code = hex!(
        ""
    );
...
fn test_parity_call_selfdestruct() {
    ...
    let traces = evm
        .into_inspector()
        .into_parity_builder()
        .into_trace_results(&res.tx_result.result, &HashSet::from_iter([TraceType::Trace]));
...
fn test_parity_call_selfdestruct_create() {
    ...
    let code = hex!(
        ""
    );
...
fn test_parity_statediff_blob_commit() {
    ...
    let res = evm
        .inspect_tx(TxEnv {
            ...
            gas_price: 150,
            blob_hashes: vec![
                "0x01af2fd94f17364bc8ef371c4c90c3a33855ff972d10b9c03d0445b3fca063ea"
                    .parse()
                    .unwrap(),
            ],
        ...
        .unwrap();
    let mut full_trace =
        evm.inspector.into_parity_builder().into_trace_results(&res.tx_result.result, &trace_types);

    let state_diff = full_trace.state_diff.as_mut().unwrap();
    populate_state_diff(state_diff, &mut db, &res.state).unwrap();
...
fn test_parity_delegatecall_selfdestruct() {
    ...
    */
    ...
    let delegate_code = hex!(
        ""
    );

    // SelfDestructTarget contract bytecode
    let target_code = hex!(
        ""
    );
...
fn vmtrace_nested_sibling_calls_keep_their_own_subtraces() {
    ...
    for (last, code) in [
        ...
        db.insert_account_info(
            ...
            AccountInfo::default().with_code(crate::utils::Bytecode::new_raw(code.into())),
        );
    }
