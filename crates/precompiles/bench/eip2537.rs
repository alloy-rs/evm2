...
use evm2_precompiles::{
    Bytes,
    bls12_381_const::{PADDED_FP_LENGTH, PADDED_G1_LENGTH, PADDED_G2_LENGTH},
};
...
mod arkworks_general {
    ...
    use evm2_precompiles::bls12_381_const::{FP_LENGTH, FP_PAD_BY, PADDED_FP_LENGTH};
    ...
    pub(super) fn encode_field_32_bytes<F: Field>(field: &F) -> Vec<u8> {
        ...
        field.serialize_uncompressed(&mut bytes_be[..]).expect("Failed to serialize field element");
        bytes_be.reverse();
    ...
    pub(super) fn encode_base_field(fp: &Fq) -> Vec<u8> {
        ...
        fp.serialize_uncompressed(&mut bytes[..]).expect("Failed to serialize field element");
...
pub fn add_g1_add_benches<M: Measurement>(group: &mut BenchmarkGroup<'_, M>) {
    use evm2_precompiles::bls12_381::g1_add::PRECOMPILE;
...
pub fn add_g2_add_benches<M: Measurement>(group: &mut BenchmarkGroup<'_, M>) {
    use evm2_precompiles::bls12_381::g2_add::PRECOMPILE;
...
pub fn add_g1_msm_benches<M: Measurement>(group: &mut BenchmarkGroup<'_, M>) {
    use evm2_precompiles::bls12_381::g1_msm::PRECOMPILE;
...
pub fn add_g2_msm_benches<M: Measurement>(group: &mut BenchmarkGroup<'_, M>) {
    use evm2_precompiles::bls12_381::g2_msm::PRECOMPILE;
...
pub fn add_pairing_benches<M: Measurement>(group: &mut BenchmarkGroup<'_, M>) {
    use evm2_precompiles::bls12_381::pairing::PRECOMPILE;
...
pub fn add_map_fp_to_g1_benches<M: Measurement>(group: &mut BenchmarkGroup<'_, M>) {
    use evm2_precompiles::bls12_381::map_fp_to_g1::PRECOMPILE;
...
pub fn add_map_fp2_to_g2_benches<M: Measurement>(group: &mut BenchmarkGroup<'_, M>) {
    use evm2_precompiles::bls12_381::map_fp2_to_g2::PRECOMPILE;
