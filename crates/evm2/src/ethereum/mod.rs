...
use crate::{
    ...
    interpreter::{
        GasTracker, Host, InstrStop, Message, MessageExt, MessageKind, MessageResultExt, Word,
...
/// the CREATE opcode instead. Earlier versions charge nothing here; a delegated recipient is
/// still resolved (for free) so the frame runs the delegate's code.
///
