...
/// SHA-256 precompile
pub(crate) const SHA256: Precompile =
    Precompile::new(PrecompileId::Sha256, crate::precompiles::u64_to_address(2), sha256_precompile);

/// RIPEMD-160 precompile
pub(crate) const RIPEMD160: Precompile = Precompile::new(
    PrecompileId::Ripemd160,
    crate::precompiles::u64_to_address(3),
...
pub(crate) fn sha256_run(input: &[u8], gas: &mut Gas) -> EthPrecompileResult {
...
pub(crate) fn ripemd160_run(input: &[u8], gas: &mut Gas) -> EthPrecompileResult {
