...
pub(crate) enum PrecompileId {
    ...
    Bls12G2Add,
    /// Multi-scalar-multiplication (MSM) in G2 (curve over quadratic extension of the base prime
    /// field).
    Bls12G2Msm,
    ...
    Bls12MapFp2ToGp2,
    /// ECDSA signature verification over the secp256r1 elliptic curve (also known as P-256 or
    /// prime256v1).
    P256Verify,
...
impl PrecompileId {
    ...
    pub(crate) fn custom<I>(id: I) -> Self
    where
    ...
    pub(crate) fn precompile(&self, spec: PrecompileSpecId) -> Option<Precompile> {
        ...
        let precompile = match self {
            ...
            Self::Ripemd160 => crate::precompiles::hash::RIPEMD160,
            ...
            Self::Blake2F => crate::precompiles::blake2::FUN,
            Self::KzgPointEvaluation => crate::precompiles::kzg_point_evaluation::POINT_EVALUATION,
            Self::Bls12G1Add => crate::precompiles::bls12_381::g1_add::PRECOMPILE,
            Self::Bls12G1Msm => crate::precompiles::bls12_381::g1_msm::PRECOMPILE,
            Self::Bls12G2Add => crate::precompiles::bls12_381::g2_add::PRECOMPILE,
            Self::Bls12G2Msm => crate::precompiles::bls12_381::g2_msm::PRECOMPILE,
            Self::Bls12Pairing => crate::precompiles::bls12_381::pairing::PRECOMPILE,
            Self::Bls12MapFpToGp1 => crate::precompiles::bls12_381::map_fp_to_g1::PRECOMPILE,
